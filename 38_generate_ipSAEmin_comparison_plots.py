...
def generate_plots_and_stats(input_file):
    ...
    # Configuration
    pairs_config = [
        ('ipTM', 'ipSAE_min', 'descending', 'descending'),           
        ('pTM_ipTM', 'ipSAE_min', 'descending', 'descending'),       
        ('ipAE', 'ipSAE_min', 'ascending', 'descending'),            
        ('pLDDT_peptide', 'ipSAE_min', 'descending', 'descending'),  
        # ('pLDDT_peptide', 'pTM_ipTM', 'descending', 'descending'),
        ('ipSAE', 'ipSAE_min', 'descending', 'descending'),
    ...
    axis_ticks = {
        ...
        'ipSAE_min': {'major': np.arange(0, 0.35, 0.1), 'minor': np.arange(0, 0.35, 0.05)},
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, f'{base_name}_plots_all_new_16_18_ipSAEmin_fixed.png'))
    plt.close()
    ...
    output_csv = os.path.join(output_dir, f'{base_name}_regression_stats_new_ipSAEmin.csv')
