    ...
    for line_no, kinase_pep in enumerate(complexes):
        ...
        # if kinase_pep == "ABL1_abltide":
            ...
            if df.iloc[:, 5].dtype.kind in 'biufc' and df.iloc[:, 7].dtype.kind in 'biufc':
                ...
                cbar = fig.colorbar(sm, ax=ax, label='ipSAE')
                ...
                # cbar.set_label(r'$\mathbf{ipSAE}$' + r'_$\mathbf{max}$', fontsize=21)
                cbar.set_label(r'$\mathbf{ipSAE}$', fontsize=21)
                ...
                figname2 = f"data/{kinase_pep}/{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_vs_ipSAE_withOriSubs_bigfont_arial_pt2pt8.png"
                fig.savefig(figname2, dpi=300, bbox_inches='tight')

                figname2_ = os.path.join(work_home, ori_sub_intermed8, kinase_pep,
                                        f"{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_vs_ipSAE_withOriSubs_bigfont_arial_pt2pt8.png"
                                        )
                ...
                figname3 = f"data/{kinase_pep}/{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_vs_ipSAE_labelled_withOriSubs_bigfont_arial_pt2pt8.png"
                if kinase_pep not in special:
                    ax.legend(loc='lower left', fontsize=14)
                fig.savefig(figname3, dpi=300, bbox_inches='tight')

                figname3_ = os.path.join(work_home, ori_sub_intermed8, kinase_pep,
                                        f"{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_vs_ipSAE_labelled_withOriSubs_bigfont_arial_pt2pt8.png"
                                        )
