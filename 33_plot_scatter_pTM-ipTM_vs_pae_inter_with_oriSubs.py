...
work_home = "/PathTo/root/working_dir"
    ...
    for line_no, kinase_pep in enumerate(complexes):
        ...
        # if kinase_pep == "ABL1_abltide":
            if kinase_pep in special:
                ...
                csvfile = f"{kinase_pep}_merged_scores_pTM-ipTM_with_oriSubs.csv"
            ...
            if df.iloc[:, 5].dtype.kind in 'biufc' and df.iloc[:, 7].dtype.kind in 'biufc':
                ...
                figname = f"data/{kinase_pep}/{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_withOriSubs_fixOrdiAbsci_opt_bigfont_arial_upd40_new.png"
                plt.legend(loc='lower left', fontsize=14)
                # plt.yticks(np.arange(6.0, 30.5, 2))
                # plt.yticks(np.arange(5.0, 30.5, 5), fontsize=20, fontweight='bold')
                plt.yticks(np.arange(6.0, 30.5, 6), fontsize=20, fontweight='bold')
                # plt.xticks(np.arange(0.3, 1.1, 0.2), fontsize=20, fontweight='bold')
                plt.xticks(np.arange(0.4, 1.0, 0.2), fontsize=20, fontweight='bold')
                # plt.xticks(np.arange(0.3, 1.1, 0.1), minor=True)
                ...
                figname_ = os.path.join(work_home, ori_sub_intermed8, kinase_pep,
                                        f"{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_withOriSubs_fixOrdiAbsci_opt_bigfont_arial_upd40_new.png"
                                        )
                ...
                cbar = fig.colorbar(sm, ax=ax, label='pLDDT_peptide')
                ...
                cbar.set_label(r'$\mathbf{pLDDT}$' + r'_$\mathbf{peptide}$', fontsize=21)
                ...
                figname2 = f"data/{kinase_pep}/{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_vs_plddt-binder_withOriSubs_rturbo_fixOrdiAbsci_opt_bigfont_arial_upd40_new.png"
                fig.savefig(figname2, dpi=300, bbox_inches='tight')

                figname2_ = os.path.join(work_home, ori_sub_intermed8, kinase_pep,
                                        f"{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_vs_plddt-binder_withOriSubs_rturbo_fixOrdiAbsci_opt_bigfont_arial_upd40_new.png"
                                        )
                ...
                figname3 = f"data/{kinase_pep}/{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_vs_plddt-binder_labelled_withOriSubs_rturbo_fixOrdiAbsci_opt_bigfont_arial_upd40_new.png"
                if kinase_pep not in special:
                    ax.legend(loc='lower left', fontsize=14)
                fig.savefig(figname3, dpi=300, bbox_inches='tight')

                figname3_ = os.path.join(work_home, ori_sub_intermed8, kinase_pep,
                                        f"{kinase_pep}_scatter_pTM-ipTM_vs_pae-inter_vs_plddt-binder_labelled_withOriSubs_rturbo_fixOrdiAbsci_opt_bigfont_arial_upd40_new.png"
                                        )
